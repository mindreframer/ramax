defmodule EventStoreTest do
  ...
  describe "RMX005_4A: EventStore Public API" do
    ...
    test "RMX005_4A_T5: append/5 returns event_id for each event" do
      ...
      {:ok, id1, store} = EventStore.append(store, "entity:1", "event.1", %{data: 1})
      {:ok, id2, store} = EventStore.append(store, "entity:1", "event.2", %{data: 2})
      {:ok, id3, store} = EventStore.append(store, "entity:1", "event.3", %{data: 3})
    ...
    test "RMX005_4A_T7: stream_all_events/2 returns a Stream" do
      ...
      # Append some events
      {:ok, _id1, store} = EventStore.append(store, "entity:1", "event.1", %{value: 1})
      {:ok, _id2, store} = EventStore.append(store, "entity:2", "event.2", %{value: 2})
      {:ok, _id3, store} = EventStore.append(store, "entity:3", "event.3", %{value: 3})
    ...
    test "RMX005_4A_T8: get_latest_sequence/1 delegation works correctly" do
      ...
      # Append events
      {:ok, _id1, store} = EventStore.append(store, "entity:1", "event.1", %{})
      {:ok, _id2, store} = EventStore.append(store, "entity:1", "event.2", %{})
      {:ok, _id3, store} = EventStore.append(store, "entity:1", "event.3", %{})
    ...
    test "RMX005_4A_EXTRA_T2: get_all_events/2 retrieves all events" do
      ...
      {:ok, _id1, store} = EventStore.append(store, "entity:1", "event.1", %{value: "a"})
      {:ok, _id2, store} = EventStore.append(store, "entity:2", "event.2", %{value: "b"})
      {:ok, _id3, store} = EventStore.append(store, "entity:1", "event.3", %{value: "c"})
    ...
    test "RMX005_4A_EXTRA_T4: events have proper timestamps" do
      ...
      {:ok, event_id, store} = EventStore.append(store, "entity:1", "event.1", %{})
